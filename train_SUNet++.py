...
arch_names = list(secmyresnetunetplus.__dict__.keys())
...
def parse_args():
    ...
    parser.add_argument('--name', default='lanzhang',
                        help='model name: (default: arch+timestamp)')
    parser.add_argument('--arch', '-a', metavar='ARCH', default='SEUnet',
                        choices=arch_names,
...
def main():
    ...
    # Data loading code
    img_paths = glob(r'..//single//data//*')
#     print(img_paths)
    mask_paths = glob(r'..//single//label//*')
    ...
    model = secmyresnetunetplus.__dict__[args.arch](args)
#     model = UNet_3Plus._dict_[args.arch](args)
